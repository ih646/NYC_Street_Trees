...
public class TreeTest {
	...
	public void testEqualsWhenNotEqual2() { 
		...
		public void testsameName(){
			Tree t1 = new  Tree ( 5, 3, "Alive", "Good", "LiNdEN",
					 10003, "Manhattan",  100, 100 ); 
			Tree t2 = new  Tree ( 15, 3, "Alive", "Good", "linden",
					 10003, "Manhattan",  100, 100 ); 
			assertTrue(t1.sameName(t2));
			
		}
		@Test
		public void testCompareName(){
			Tree t1 = new  Tree ( 15, 3, "Alive", "Good", "andle",
					 10003, "Manhattan",  100, 100 ); 
			Tree t2 = new  Tree ( 15, 3, "Alive", "Good", "XAndle",
					 10003, "Manhattan",  100, 100 ); 
			assertTrue(t1.compareName(t2)<0);
			TreeCollection x=new TreeCollection();
			x.add(t1);
